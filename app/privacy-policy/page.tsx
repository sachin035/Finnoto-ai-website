      ...
      <div className="container gap-12 pt-16 flex flex-col">
        ...
        <div className="flex flex-col gap-2 [&>p]:text-sm [&>p]:leading-6">
          ...
          <p>
            ...
            2000 & 2021 and the rules made thereunder and the amended provisions
          ...
          <p>
            This privacy policy (“Policy”) explains our Company’s policy
            regarding the collection, use, disclosure and transfer of your data
            by Finnoto Solution Private Limited, a private limited company
            incorporated under Indian Company Act 2013, CIN
            U72900KA2022PTC165727 with its registered office at No. 46/1,
            Bhattarahalli Village, Virgo Nagar, P.O., Bangalore, Karnataka,
            India, 560036 or any of its affiliate(s) (“we” or “us” or “our”)
            using the website{" "}
            <Link
          ...
          <p>
            ...
            Finnoto Solution Private Limited (hereinafter called “Finnoto”)
            (both terms defined below). the terms of this privacy policy will be
            effective upon your acceptance of the same (directly or indirectly
            in electronic form, by use or the website or by other means) and
            will govern the relationship between you and Finnoto for your use of
            the website (defined below).
          </p>
          <p>
            ...
            provides information on the manner in which your data is collected
            and used by the Finnoto on the Site. As a visitor to the Site/
            Customer you are advised to please read the Privacy Policy
            carefully. By accessing the services provided by the Site you agree
            to the collection and use of your data by the Finnoto in the manner
          ...
          <p>
            ...
            please do not use this website. you hereby provide your
            unconditional consent or agreements to the Finnoto as provided under
            section 43a and section 72a of information technology act, 2000.The
            User may revoke its consent for providing the sensitive information
            (as defined under Information Technology (Reasonable security
            practices and procedures and sensitive personal data or information)
            Rules, 2011) by reaching out to Finnoto support in writing and
            Finnoto may discontinue to provide services, which are depended or
            requires such sensitive information.
          </p>
        </div>
        ...
        <div className={gapClass}>
          ...
          <p>
            Finnoto collects personally identifiable information about you only
            ...
            DoubleClick cookie) together to inform, optimise, and serve ads
        ...
        <div className={gapClass}>
          ...
          <p>
            In serving you, Finnoto name may use or store your precise
            geographic location, if you give us permission to do so. We do not
            use or share this data for any other purpose. Many devices will
            indicate through an icon when location services are operating. We
            only share this location information with others as approved by you.
          </p>
        </div>
        <div className={gapClass}>
          ...
          <p>
            ...
            you. Finnoto will use this information to preserve transaction
            history as governed by existing law or policy. Finnoto may also use
            ...
            contest sponsors or advertisers. Finnoto will also use this
            ...
            aggregate (excluding any information that may identify you
            specifically) covering Customer transaction data and Customer
            demographic and location data may be provided to partners of the
            Finnoto for the purpose of creating additional features on the
        ...
        <div className={gapClass}>
          ...
          <p>
            Finnoto will not use your financial information for any purpose
            other than to complete a transaction with you. Finnoto does not
            rent, sell or share your personal information and will not disclose
            any of your personally identifiable information to third parties. In
            cases where it has your permission to provide products or services
            you’ve requested and such information is necessary to provide these
            products or services the information may be shared with Finnoto
          ...
          <p>
            ...
            although data security cannot be guaranteed. Finnoto , generally do
            not share personally identifiable information (such as name,
            address, email or phone) with other companies or allow advertising
            companies to collect data through our service for ad targeting.
          </p>
        </div>
        <div className={gapClass}>
          ...
          <div className="mt-2 lg:ml-6">
            ...
            <li className="list-decimal">
              to any successor or purchaser in a merger, acquisition,
          ...
          <p>
            ...
            to the safety or security of any person, violations of the its terms
            of use or to defend against legal claims; special circumstances such
            as compliance with subpoenas, court orders, requests/order from
        ...
        <div className={gapClass}>
          ...
          <p>
            To protect against the loss, misuse and modification or alteration
            of the information under its control, Finnoto will take reasonable
            steps to secure your personally identifiable information against
            unauthorized access or disclosure. We encrypt transmission of data
            on pages where you provide payment information. However, no security
            or encryption method can be guaranteed to protect information from
          ...
          <p>
            ...
            this site, you agree that Finnoto will have no liability for
            disclosure of your information due to errors in transmission or
            unauthorized acts of third parties.
          </p>
          <p>
            Information collected may be stored or processed on computers
        ...
        <div className={gapClass}>
          ...
          <p>
            ...
            time. If we make any material changes to our policies, we will place
            a prominent notice on our website or application. Any changes we
            make will be effective immediately on notice, which we may give by
            posting the new policy on the Site. Your use of the Services after
            such notice will be deemed acceptance of such changes. We may also
            make reasonable efforts to inform you via electronic mail. In any
            case, you are advised to review this Policy periodically on the Site
            to ensure that you are aware of the latest version. In the event you
            have any grievance relating to the processing of Information
            provided by you, you may contact our Grievance Officer or write to
        ...
        <div className={gapClass}>
          ...
          <p>
            ...
            or write data efficiently from our server for the creation of
            expenses and reimbursements based on expenses and other data that is
            received in gmail,as explained in the justification of viewing email
            messages and settings, ensuring the security of your information.
          </p>
          <p>
            It&apos;s essential for accessing your business details and vendor
            details, making it easier to raise expenses and send them to the
        ...
        <div className={gapClass}>
          ...
          <p>
            Finnoto use and transfer to any other app of information received
