...
const WorkingMethod = () => {
  ...
  return (
    <Container className="flex justify-center ">
      <div className="border relative rounded-lg p-6 sm:p-8 md:p-12 bg-white w-[80%] flex flex-col justify-center">
        {/* <span className="text-[24px] md:text-[40px] font-semibold text-center mb-8 bg-white z-10">
          How It work
        </span> */}
        <div className="w-fit mx-auto text-[24px] md:text-[40px] font-semibold text-center mb-8 bg-white z-10">
          <h2 className="text-2xl font-bold">How It Work</h2>
        </div>

        {/* Replace grid with flex layout for more precise control */}
        <div className="flex flex-wrap justify-center gap-8">
          ...
          {methods.map((method, index) => {
            ...
            return (
              <div
                key={index}
                className="flex flex-col items-center z-10 bg-white w-[191px] mb-8 mx-2 xl:mx-0"
              >
                <div className="border rounded-lg shadow-md p-4 w-full aspect-square flex flex-col h-[222px]">
                  <div className="h-[87px] w-[34px] text-center text-5xl md:text-6xl font-bold text-gray">
                    {method.number}
