    ...
    <>
      ...
      >
        <Container
          ...
          } items-center h-navbar rounded-full border border border-[rgba(213,215,218,0.5)] shadow-[0px_8px_10px_#0C0C0D0D] px-6`}
        >
          <Link href="/">
            <Image
          ...
          <div className="hidden md:flex md:gap-4 text-primary-black items-center">
            <Link href="/about">About Us</Link>
